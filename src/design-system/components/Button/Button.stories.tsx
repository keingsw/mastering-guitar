...
const meta: Meta<typeof Button> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A versatile button component with multiple variants, sizes, and states. Fully accessible with keyboard navigation and loading states.",
      },
    },
  },
  tags: ["autodocs"],
  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px", maxWidth: "300px" }}>
      ...
      <p style={{ fontSize: "14px", color: "#666", margin: 0 }}>
        All buttons support keyboard navigation (Tab, Enter, Space) and have proper ARIA attributes. Use Tab to navigate
        between buttons and press Enter or Space to activate.
      </p>
    </div>
  ),
  parameters: {
