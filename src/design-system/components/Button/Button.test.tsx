...
describe("Button Component", () => {
  ...
  describe("Variants", () => {
    it("should render primary variant by default", () => {
      ...
      expect(button.style.backgroundColor).toBe("rgb(35, 131, 226)");
    ...
    it("should render secondary variant correctly", () => {
      ...
      expect(button.style.border).toContain("rgb(209, 213, 219)");
    });
    ...
    it("should render outline variant correctly", () => {
      ...
      expect(button.style.color).toBe("rgb(35, 131, 226)");
      expect(button.style.border).toContain("rgb(35, 131, 226)");
    });
    ...
    it("should render musical variant with special styling", () => {
      ...
      const button = screen.getByRole("button");
      expect(button.style.backgroundColor).toBe("rgb(217, 119, 6)");
  ...
  describe("Sizes", () => {
    it("should render medium size by default", () => {
      ...
      expect(button.style.paddingRight).toBe("12px");
    });
  ...
  describe("WCAG 2.1 AA Compliance", () => {
    it("should meet color contrast requirements for primary variant", () => {
      ...
      const button = screen.getByRole("button");
      // Primary uses blue background with white text
    ...
    it("should meet color contrast requirements for secondary variant", () => {
      ...
      expect(button.style.backgroundColor).toBe("rgb(243, 244, 246)");
      expect(button.style.color).toBe("rgba(55, 53, 47, 0.95)");
    });
  ...
  describe("Animations", () => {
    it("should have transition property for smooth interactions", () => {
      ...
      const button = screen.getByRole("button");
      expect(button.style.transition).toBe("all 0.15s ease");
    });
    ...
    it("should have hover effects for musical variant", async () => {
      ...
      await waitFor(() => {
        // Hover effects are handled by CSS pseudo-classes, not inline styles
        // The transform would only be visible in actual CSS :hover state
        expect(button.style.backgroundColor).toBe("rgb(217, 119, 6)");
      });
    });
  });
