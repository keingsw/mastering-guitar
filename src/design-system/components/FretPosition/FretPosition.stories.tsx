...
const meta: Meta<typeof FretPosition> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A fret position component for displaying notes on a guitar fretboard. Shows harmonic functions with color coding and shape symbols for accessibility. Fully interactive with hover and focus states.',
      },
    },
  },
  tags: ['autodocs'],
  argTypes: {
    note: {
      control: { type: 'text' },
      description: 'The note name to display (e.g., "C", "F#", "B♭")',
    },
    function: {
      control: { type: 'select' },
  ...
  render: () => (
    <div style={{ display: 'flex', gap: '12px', alignItems: 'center', padding: '20px', backgroundColor: '#fafafa', borderRadius: '8px' }}>
      ...
      <div style={{ marginLeft: '16px', fontSize: '14px', color: '#333' }}>
        <strong>C Major Triad</strong><br/>
...
export const AccessibilityDemo: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Comprehensive accessibility features including ARIA labels, keyboard navigation, and colorblind support.',
      },
    },
  },
};
...
export const AccidentalNotes: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
      ...
      <FretPosition note="B♭" function="third" isHighlighted />
