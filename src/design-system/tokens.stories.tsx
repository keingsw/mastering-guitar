...
import { colors, componentTokens, fontSizes, fontStacks, fontWeights, musicalSpacing, wcagCompliance } from "./tokens";
...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Design tokens are the foundation of our design system, providing consistent values for colors, typography, spacing, and other design decisions.",
      },
    },
  },
  tags: ["autodocs"],
  ...
  render: () => (
    <div style={{ padding: "20px" }}>
      ...
      <div style={{ marginBottom: "32px" }}>
        <h3 style={{ marginBottom: "16px", fontFamily: "Inter", fontSize: "18px", fontWeight: "500" }}>
          Primary Colors
        </h3>
...
export const Typography: Story = {
  render: () => (
    <div style={{ padding: "20px" }}>
      <h2 style={{ marginBottom: "20px", fontFamily: "Inter", fontSize: "24px", fontWeight: "600" }}>
        Typography System
      </h2>
      ...
      <div style={{ marginBottom: "32px" }}>
        ...
        <div style={{ display: "grid", gap: "16px" }}>
          <div style={{ padding: "16px", backgroundColor: "#fafafa", borderRadius: "8px" }}>
            ...
            <div style={{ fontSize: "12px", color: "#666", fontFamily: "monospace" }}>{fontStacks.primary}</div>
          </div>
          <div style={{ padding: "16px", backgroundColor: "#fafafa", borderRadius: "8px" }}>
            ...
            <div style={{ fontSize: "12px", color: "#666", fontFamily: "monospace" }}>{fontStacks.mono}</div>
          </div>
        </div>
      </div>
...
export const WCAGCompliance: Story = {
  render: () => (
    <div style={{ padding: "20px" }}>
      ...
      <div>
        <h3 style={{ marginBottom: "16px", fontFamily: "Inter", fontSize: "18px", fontWeight: "500" }}>
          Music Theory Color Contrast
        </h3>
        <p style={{ fontSize: "14px", color: "#666", marginBottom: "16px", lineHeight: "1.5" }}>
          Theory function colors with white text meet contrast requirements for readability.
        </p>
        <div style={{ display: "grid", gap: "12px" }}>
          {wcagCompliance.theoryContrast.map(({ text, background, ratio }, index) => {
            const functionNames = ["Root", "Third", "Fifth"];
