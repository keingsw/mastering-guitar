...
const meta: Meta<typeof ChordDisplay> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A chord display component for showing chord symbols, notes, and intervals. Designed specifically for music education applications with clear typography and optional interactive features.",
      },
    },
  },
  tags: ["autodocs"],
...
export const ComplexChords: Story = {
  render: () => (
    <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
      ...
      <ChordDisplay chord="F#dim7" notes={["F#", "A", "C", "Eb"]} showNotes />
      <ChordDisplay chord="Bbsus4" notes={["Bb", "Eb", "F"]} showNotes />
...
export const GuitarTriads: Story = {
  render: () => (
    <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "16px", maxWidth: "600px" }}>
      ...
      <ChordDisplay chord="B°" notes={["B", "D", "F"]} showNotes intervals={["R", "m3", "b5"]} showIntervals />
    </div>
  ),
  parameters: {
    docs: {
  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px", maxWidth: "400px" }}>
      ...
      <p style={{ fontSize: "14px", color: "#666", margin: 0 }}>
        Chord displays have proper ARIA labels that announce both the chord name and notes. Interactive chords can be
        navigated with keyboard (Tab, Enter, Space). Screen readers will announce: "Chord: Cmaj7, Notes: C, E, G, B".
      </p>
    </div>
  ),
  parameters: {
